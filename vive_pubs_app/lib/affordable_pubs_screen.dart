...
class AffordablePubsScreenState extends State<AffordablePubsScreen> 
{
  ...
  {
    final response = await http.get(Uri.parse('http://192.168.1.36:1337/api/pubs/affordable?maxPrice=15'),);
                  ...
                  (
                    ...
                    [
                      ...
                      (
                        ...
                        child: Image.network('http://192.168.1.36:1337${pub['picture']['url']}',
                        width: 50,
                        height: 50,
                        ),
                      ),
